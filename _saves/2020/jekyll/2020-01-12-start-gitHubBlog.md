...
[https://github.com/homkim/homkim.github.com/blob/master/_config.yml]({{"https://github.com/homkim/homkim.github.com/blob/master/_config.yml"}}){:target="_blank"} 
...
url                      : "https://homkim.github.io/" # GitBlog 호스트 주소
baseurl                  : # subPath https://homkim.github.io/blog라고 하고 싶을 시 "/blog" 라고 적는다.
repository               : "homkim/homkim.github.com" # GitHub username/repo-name  
...
[https://github.com/homkim/homkim.github.com/blob/master/_data/navigation.yml]({{"https://github.com/homkim/homkim.github.com/blob/master/_data/navigation.yml"}}){:target="_blank"}
...
[https://github.com/homkim/homkim.github.com/tree/master/_pages]({{"https://github.com/homkim/homkim.github.com/tree/master/_pages"}}){:target="_blank"} <br>
<br>
...
[https://github.com/homkim/homkim.github.com/blob/master/package.json]({{"https://github.com/homkim/homkim.github.com/blob/master/package.json"}}){:target="_blank"} <br>
...
[https://github.com/homkim/homkim.github.com/blob/master/_sass/minimal-mistakes.scss]({{"https://github.com/homkim/homkim.github.com/blob/master/_sass/minimal-mistakes.scss"}}){:target="_blank"} 
```css
/* Custom */
...
[https://github.com/homkim/homkim.github.com/blob/master/Gemfile]({{"https://github.com/homkim/homkim.github.com/blob/master/Gemfile"}}){:target="_blank"}
```
...
comments:
  ...
  disqus:
    shortname            : homkim # https://help.disqus.com/customer/portal/articles/466208-what-s-a-shortname-
...
[https://github.com/homkim/homkim.github.com/blob/master/robots.txt]({{"https://github.com/homkim/homkim.github.com/blob/master/robots.txt"}}){:target="_blank"}
```
User-agent: *
Allow: /

Sitemap: https://homkim.github.io/sitemap.xml
```
